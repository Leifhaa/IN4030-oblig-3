 ...
 * @changed 2022.02.25 by @author Kari Stamnes
 *
...
public class Oblig3Precode {
    ...
    /**
     * Writes the factors you found to a file named "Factors_n_variation.txt"
     * variation-string is intended for seperating seqential solution from one or several parallell solutions. 
     */

    public void writeFactors(String variation) {
        String filename = "Factors_" + n + "_" + variation + ".txt";
